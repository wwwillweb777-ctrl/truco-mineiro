...
function joaoJoga() {
    const melhorForca = Math.max(...cartasJoao.map(c => c.forca));
    const indiceMelhor = cartasJoao.findIndex(c => c.forca === melhorForca);
